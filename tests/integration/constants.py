...
notifier_now_aval_values = ["Привет товар появился в наличии", """[​](https://basket-01.wb.ru/vol0/part88/88000/images/big/1.webp)Название товара: Cолнцезащитные очки
Изначальная цена товара: 300.0
Последняя измененная цена товара: 5555
Разница в цене: 5255.0
Текущий порог оповещения: всегда"""]
notifier_now_not_aval_values = ["Привет товара больше нет в наличии", """[​](https://basket-01.wb.ru/vol0/part88/88000/images/big/1.webp)Товара нет в наличии!
